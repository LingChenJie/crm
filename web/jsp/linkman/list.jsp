                            ...
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    ...
                                    <td>
                                        ...
                                        <input class="textbox" style="width: 80px" maxlength="50"
                                               name="cust_name" id="cust_name" value="${param['cust_name']}">
                                        <input type="button" value="选择客户"
                                               onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','',
