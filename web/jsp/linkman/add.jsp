                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <input name="cust_name" style="WIDTH: 180px" id="cust_name"
                    ...
                    <TR>
                        ...
                        <td>联系人性别：</td>
                        <td>
                            <input type="radio" value="1" name="lkm_gender" <s:property
                                    value="#linkMan.lkm_gender=='1'?'checked':''"/>>男
                            <input type="radio" value="2" name="lkm_gender" <s:property
                                    value="#linkMan.lkm_gender=='2'?'checked':''"/>>女
                        </td>
                    </TR>
                    <TR>
                        <td>联系人办公电话 ：</td>
